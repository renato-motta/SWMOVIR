    ...
    <x-wire-card>
        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <div class="grid lg:grid-cols-4 gap-4">
                ...
                <x-wire-select class="lg:col-span-2" label="Almacenes" wire:model="warehouse_id" placeholder="Seleccione un almacén" :async-data="[
                ...
                <x-wire-select class="lg:col-span-2" label="Motivo" wire:model="reason_id" placeholder="Seleccione un motivo" :async-data="[
