<div>
    <x-wire-card>
        <h1 class="text-2xl font-semibold  text-gray-800 mb-6">Importar categorias desde excel</h1>
        <x-wire-button blue wire:click="downloadTemplate">
            <i class="fas fa-file-excel"></i>
            Descargar plantilla
        </x-wire-button>
        <p class="text-sm text-gray-500 mt-1"> 
            Completa la plantilla con los datos de tus categorias y súbela aquí 
        </p>
        ...
        <div class="mt-4">
            <x-wire-button green wire:click="importCategories" wire:loading.attr="disabled" wire:target="file" spinner="importCategories">
            ...
            <div class="mt-4">
                <div class="p-4 bg-yellow-100 border border-yellow-300 rounded-md text-yellow-800 mb-3">
                    ...
                    @else
                        ...
                        <p class="mt-1 text-sm">Todas las categorias tienen errores o el archivo no es válido</p>
                    @endif
                </div>
