    ...
    <x-wire-card>
        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <div class="grid lg:grid-cols-4 gap-4">
                ...
                {{-- class="space-y-4 lg:flex lg:space-x-2"    lg:gap-2--}}
                <div class="grid lg:grid-cols-2 gap-4">
                    <x-wire-input label="Serie" wire:model="serie" placeholder="Serie de Comprobante" disabled>
                    </x-wire-input>
                ...
                <x-wire-select label="Almacen origen" wire:model.live="origin_warehouse_id" placeholder="Seleccione un almacén" :async-data="[
                ...
                <x-wire-select label="Almacen destino" wire:model="destination_warehouse_id" placeholder="Seleccione un almacén" :async-data="[
                    'api'=> route('api.warehouses.index'), 
                    'method'=> 'POST',
                    'params'=>[
