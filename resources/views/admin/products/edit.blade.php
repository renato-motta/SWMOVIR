<x-admin-layout
    ...
    <x-wire-card>
        <form action="{{route('admin.products.update', $product)}}" method="POST"class="space-y-4">
            ...
            <x-wire-input type="number" label="Precio" name="price" placeholder="Precio del producto" value="{{old('price',$product->price)}}" min="0.01" step="0.01">
            </x-wire-input>
       ...
       <script>
        Dropzone.options.myDropzone = {
            ...
            init: function() {
                ...
                //success se ejeduta cuando se ha subido correctamente la imagen
