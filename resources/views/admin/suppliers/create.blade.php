    ...
    <x-wire-card>
        <form action="{{route('admin.suppliers.store')}}" method="POST"class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <x-wire-input label="Número de documento" name="document_number" placeholder="Nombre del documento" value="{{old('document_number')}}">
            </div>
            </x-wire-input>
            ...
            <x-wire-input label="Email" name="email" placeholder="Correo electronico del proveedor" value="{{old('email')}}">
            </x-wire-input>
